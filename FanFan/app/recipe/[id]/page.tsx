    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white px-4 py-3 border-b border-gray-100">
          <div className="h-5 w-24 mx-auto rounded skeleton-shimmer" />
        </div>
        <div className="flex justify-center pt-5 pb-3">
          <div className="w-48 h-48 rounded-2xl skeleton-shimmer" />
        </div>
        <div className="px-5 space-y-2 text-center">
          <div className="h-6 w-3/4 mx-auto rounded skeleton-shimmer" />
          <div className="h-4 w-1/3 mx-auto rounded skeleton-shimmer" />
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 safe-area-top pb-24">
      ...
      <div className="bg-white flex items-center justify-between px-4 py-3 border-b border-gray-100">
        ...
        <h2 className="text-sm font-semibold text-gray-500">Recipe Details</h2>
        <button
          onClick={() => setPackSheetOpen(true)}
          className="p-2 -mr-2 rounded-full hover:bg-orange-50 text-orange-500 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <div className="flex justify-center px-6 pt-5 pb-3">
        <img
          src={recipe.image}
          alt={recipe.title}
          className="w-48 h-48 sm:w-56 sm:h-56 rounded-2xl object-cover shadow-md"
        />
      </div>
