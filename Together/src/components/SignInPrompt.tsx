  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 px-8 text-center">
      ...
      <button
        ...
        className="flex items-center gap-3 bg-white border border-gray-200 rounded-2xl px-6 py-3 text-sm font-semibold text-gray-700 shadow-sm hover:shadow-md active:scale-95 transition-all"
      >
